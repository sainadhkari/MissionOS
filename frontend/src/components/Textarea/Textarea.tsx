...
function Textarea({ id, label, error, helperText, className = '', ...props }: TextareaProps) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        id={id}
        className={`rounded-md border bg-white px-3 py-2 text-sm text-neutral-900 placeholder:text-neutral-400 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-0 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder:text-neutral-500 ${
          error
